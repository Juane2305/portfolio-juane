    ...
    return (
        <div className='flex justify-center' id='technologies'>
            <div className='pt-10 pb-24 bg-[#E8E8D8] w-full'>
                <h1 className='text-[4rem] pt-10 text-[#2B3033] font-bold text-center'>My knowledge</h1>
                <div className='flex lg:flex-col justify-center items-center px-10'>
                    <div className='flex flex-col lg:flex-row justify-center items-center lg:gap-x-16 gap-y-10 lg:gap-y-0 lg:pt-16'> 
                    ...
                    <div className='flex flex-col lg:flex-row justify-center items-center lg:gap-x-12 gap-y-10 lg:gap-y-0 lg:pt-10'>    
